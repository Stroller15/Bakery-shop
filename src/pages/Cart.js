          ...
          <div className="min-h-[80vh] grid md:grid-cols-2 max-w-6xl mx-auto">
            ...
            <div>
              <div className="flex flex-col justify-center items-end p-5 space-y-5 mt-14">
                ...
                <button onClick={() => console.log({totalAmount})} className="bg-purple-700 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-purple-600 font-bold hover:text-purple-700 p-3">
                  Checkout Now
                </button>
              </div>
            </div>
